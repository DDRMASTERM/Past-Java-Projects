...
public class ThreadExample implements Runnable 
{
   ...
   public void addTest(){ //This just adds 3 numbers into the array
         threadStorage.add( taskName, 1 );
         threadStorage.add( taskName, 2 );
         threadStorage.add( taskName, 3 );
   }
   ...
   public static void main( String[] args )
   {
      ...
      Thread thread1 = new Thread( new ThreadExample( "task1") );
      Thread thread2 = new Thread( new ThreadExample( "task2") );
      Thread thread3 = new Thread( new ThreadExample( "task3") );
